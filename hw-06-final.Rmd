...
From the above table and segmented bar chart, we can see that there is a higher proportion of cancer diagnosis for the birdkeepers than for the non-birdkeepers. While only 20% of non-birdkeepers were diagnosed with cancer, almost 50% of birdkeepers were diagnosed with cancer.
